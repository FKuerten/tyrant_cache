    ...
    namespace CLI {
        ...
        int RunCommand::execute() {
            ...
            std::cout << "                                 " << std::setw(11) << "Count"
                      << " " << std::setw(6) << "avg." << std::endl;
            std::cout << "Games played:                    " << std::setw(11) << r.numberOfGames
                      << std::endl;
            std::cout << "Games won:                       " << std::setw(11) << r.gamesWon
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getWinRate() << std::endl;
            std::cout << "Games lost:                      " << std::setw(11) << r.gamesLost
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getLossRate() << std::endl;
            std::cout << "Games stalled:                   " << std::setw(11) << r.gamesStalled
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getStallRate() << std::endl;
            std::cout << "Points for attacker on manual: " << std::setw(13) << r.pointsAttacker
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getManualANPAttacker() << std::endl;
            std::cout << "Points for attacker on auto:   " << std::setw(13) << r.pointsAttackerAuto
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getAutoANPAttacker() << std::endl;
            std::cout << "Points for defender on manual: " << std::setw(13) << r.pointsDefender
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getManualANPDefender() << std::endl;
            std::cout << "Points for defender on auto:   " << std::setw(13) << r.pointsDefenderAuto
                      << " " << std::setw(6) << std::fixed << std::setprecision(3) << r.getAutoANPDefender() << std::endl;
            return 0;
        }
